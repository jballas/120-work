...
function draw(){
    ...
    //Petals will move automatically
    petal_angle ++;

    // text intructions at the bottom
    textSize( 20 );
    fill( 255 );
    text( ' Click your mouse to attract more bees', 100, 650 );
}


// Here is a function to change the bee's location randomly when you click the mouse. The bees are permanent after you add one.
...
function bee(x,y){
    ...
    push();
        ...
        // I made a pattern of stripes using a loop. Then, I had to add in a y loop to make sure the x,y variables could be changed. Math hurts.
        for( s = x; s < x + 20; s+= 5 ){
            for ( t = y; t < y + 20; t+=5 ){
                line( x - 20, t, x + 15, t );
            }
    ...
    // Before I can make a loop, I still have to create all the lines with all the various numbers. Otherwise I don't understand the math. Here is the original code for the stripes:
