...
// Bee location variables. It will start in the middle of the screen
...
function draw(){
    ...
    // I want to make my flowers repeat in a grid on the screen
    ...
    //Petals will move authomatically
    petal_angle ++;

    // text intructions at the bottom
    textSize(20);
    fill(255);
    text(' If you click you might attract more bees', 100, 650);
}


// A function to change the bee's location randomly when you click the mouse.

function mousePressed(){
    b_location_x = random (position);
    b_location_y = random (position);
   
   // Unfortunately I had add the background, otherwise the bee would become permanent bees on the sketch.
    //background (0);
   }
...
function bee(x,y){
    ...
    push();
        ...
        // I made a pattern of stripes using a loop. I had to add in a y loop to make sure the x,y variables could be changed. Math hurts.
        for(s = x; s < x + 20; s+= 5){
            for ( t = y; t < y + 20; t+=5){
                line(x - 20, t, x + 15, t);
            }
    ...
    // Before I can make a loop, I still have to create all the lines with all the various numbers. Otherwise I don't understand the math. Here is the original code for stripes:
